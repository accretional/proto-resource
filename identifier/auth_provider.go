...
type AuthFlow interface {
	...
	Handle(first *pb.Identity, stream grpc.BidiStreamingServer[pb.Identity, pb.Resource]) error
}
...
func (d *AuthDispatcher) Handle(stream grpc.BidiStreamingServer[pb.Identity, pb.Resource]) error {
