...
func (f *Token) Match(first *pb.Identity) bool {
	return first.GetSecret() != ""
}

func (f *Token) Handle(first *pb.Identity, stream grpc.BidiStreamingServer[pb.Identity, pb.Resource]) error {
...
// Ensure Token implements identifier.AuthFlow.
var _ identifier.AuthFlow = (*Token)(nil)
