...
func (f *Invite) Match(first *pb.Identity) bool {
	return first.GetSecret() == ""
}

func (f *Invite) Handle(first *pb.Identity, stream grpc.BidiStreamingServer[pb.Identity, pb.Resource]) error {
...
// Ensure Invite implements identifier.AuthFlow.
var _ identifier.AuthFlow = (*Invite)(nil)
