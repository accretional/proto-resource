...
// SendMagicAuth triggers a magic-auth email to the given address.
//
...
// AuthenticateMagicAuthResponse holds the result of verifying a magic auth code.
...
// DeviceAuthorization holds the response from the device authorization endpoint.
...
// DeviceTokenResponse holds the successful authentication result from polling.
