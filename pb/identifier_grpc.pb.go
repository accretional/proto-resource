...
const (
	Identifier_Authenticate_FullMethodName = "/resource.Identifier/Authenticate"
	Identifier_Authority_FullMethodName    = "/resource.Identifier/Authority"
	Identifier_Identify_FullMethodName     = "/resource.Identifier/Identify"
)
...
type IdentifierClient interface {
	...
	Authenticate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Identity, Resource], error)
	...
	Identify(ctx context.Context, in *Resource, opts ...grpc.CallOption) (*Identity, error)
}
...
func (c *identifierClient) Authenticate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[Identity, Resource], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Identifier_ServiceDesc.Streams[0], Identifier_Authenticate_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Identity, Resource]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Identifier_AuthenticateClient = grpc.BidiStreamingClient[Identity, Resource]
...
func (c *identifierClient) Identify(ctx context.Context, in *Resource, opts ...grpc.CallOption) (*Identity, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Identity)
...
type IdentifierServer interface {
	...
	// Those help inform the resource targets of a subsequent Plan92.CreateSession (authorization)
	// Before then, an auth flow may be required
	Authenticate(grpc.BidiStreamingServer[Identity, Resource]) error
	// Determine if the resource of this name belongs to this server, and if so, its local identity, if not, a remote authority
	Authority(context.Context, *Identity) (*Identity, error)
	// Request the identity of the owner of this resource
	// Can also be used to check the identity of this service/identity provider, by asking about "system"/id=0
	Identify(context.Context, *Resource) (*Identity, error)
...
func (UnimplementedIdentifierServer) Authenticate(grpc.BidiStreamingServer[Identity, Resource]) error {
...
func (UnimplementedIdentifierServer) Identify(context.Context, *Resource) (*Identity, error) {
...
func RegisterIdentifierServer(s grpc.ServiceRegistrar, srv IdentifierServer) {
	// If the following call panics, it indicates UnimplementedIdentifierServer was
...
func _Identifier_Authenticate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(IdentifierServer).Authenticate(&grpc.GenericServerStream[Identity, Resource]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Identifier_AuthenticateServer = grpc.BidiStreamingServer[Identity, Resource]
...
func _Identifier_Identify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentifierServer).Identify(ctx, req.(*Resource))
	}
	return interceptor(ctx, in, info, handler)
}
